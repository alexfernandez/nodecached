...
var commands = {};
commands.overwriteWith(SET_COMMANDS);
commands.overwriteWith(GET_COMMANDS);
commands.overwriteWith(DELETE_COMMANDS);
 ...
 */
function interpret(command, options, data)
{
